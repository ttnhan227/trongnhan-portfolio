  ...
  return (
    <section className="hero-section" id="init" aria-labelledby="hero-name">
      <div className="hud-content-container">
        ...
        <div className="title-screen-bar pixel-box-sm">
        ...
        <div className="hero-grid">
          ...
          <div className="hero-player-panel pixel-box">
            <div className="pixel-box-header">
              <div className="box-title-wrap">
                <RpgIcon id={1} size={20} alt="Hero Sword" />
                <span className="box-title-text">CHARACTER SHEET // STATS</span>
              </div>
            ...
            <div className="hero-player-body">
              ...
              <div className="hero-profile-header">
                <div className="avatar-portrait-wrap pixel-frame">
                  <img
                    src="/images/assets/avatar/avatar.gif"
              ...
              <div className="rpg-attributes-grid">
                <div className="attribute-pill pixel-frame-xs">
              ...
              {/* Equipped Primary Arsenal */}
              <div className="hero-quick-stack">
                <span className="quick-stack-label">EQUIPPED WEAPONRY & GEAR:</span>
                <div className="quick-stack-tags">
                  <span className="hero-tech-badge">FastAPI</span>
                  <span className="hero-tech-badge">.NET 8</span>
                  <span className="hero-tech-badge">Spring Boot</span>
                  <span className="hero-tech-badge">PostgreSQL</span>
                  <span className="hero-tech-badge">React</span>
                  <span className="hero-tech-badge">Docker</span>
                </div>
              </div>

              {/* RPG Battle Command Action Buttons */}
              <div className="hero-action-menu">
                <a className="rpg-menu-btn btn-primary" href="#missions">
                  <RpgIcon id={1} size={16} alt="Sword" />
                  <span>VIEW QUESTS</span>
                </a>

                <a className="rpg-menu-btn" href="/Tran_Trong_Nhan_CV.pdf" target="_blank" rel="noreferrer">
                  <RpgIcon id={11} size={16} alt="Scroll" />
                  <span>RÉSUMÉ (PDF)</span>
                  <ArrowUpRight />
                </a>

                <a className="rpg-menu-btn" href="https://github.com/ttnhan227" target="_blank" rel="noreferrer">
                  <span>GitHub</span>
                  <ArrowUpRight />
                </a>

                <a className="rpg-menu-btn" href="https://www.linkedin.com/in/trantrongnhan" target="_blank" rel="noreferrer">
                  <span>LinkedIn</span>
                  <ArrowUpRight />
                </a>
          ...
          {/* Right: Guild Hero Showcase Box */}
          <div className="hero-artwork-panel pixel-box">
            <div className="pixel-box-header">
              <div className="box-title-wrap">
                <RpgIcon id={29} size={20} alt="Shield Crest" />
                <span className="box-title-text">HERO SHOWCASE // GUILD SEAL</span>
              </div>
              <span className="art-badge">S-RANK</span>
            </div>

            <div className="hero-artwork-body fantasy-hero-body">
              <div className="hero-sprite-showcase-box pixel-frame">
                <div className="sprite-frame-top">
                  <span className="guild-seal-tag">✦ ADVENTURER GUILD CITATION ✦</span>
                </div>
                <div className="sprite-large-display">
                  <img
                    src="/images/assets/avatar/avatar.gif"
                    alt="Tran Trong Nhan Full Animated Character Sprite"
                    className="sprite-large-img"
                  />
              ...
              {/* Character Passive Abilities / Specializations */}
              <div className="character-passives-box pixel-frame-xs">
